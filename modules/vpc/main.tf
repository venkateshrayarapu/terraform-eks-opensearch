...
resource "aws_security_group" "bastion" {
  ...
  # Add explicit HTTPS egress rule
  egress {
    from_port   = 443
    to_port     = 443
    protocol    = "tcp"
...
# Update policy for EKS access with more permissions
...
resource "aws_instance" "bastion" {
  ...
  key_name      = "bastion-key-new"  # Updated key name
